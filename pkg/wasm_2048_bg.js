import * as wasm from './wasm_2048_bg.wasm';
...
export class Game {
    ...
    */
    get is_game_win() {
        const ret = wasm.game_is_game_win(this.ptr);
        return ret !== 0;
    }
    /**
    * @returns {boolean}
    */
    get is_game_over() {
        const ret = wasm.game_is_game_over(this.ptr);
        return ret !== 0;
    }
    /**
    */
    generate() {
        wasm.game_generate(this.ptr);
    }
    /**
    * @param {number} dir
    * @param {boolean} gen
    */
    move_cells(dir, gen) {
        wasm.game_move_cells(this.ptr, dir, gen);
    }
}
